...
<body>
    ...
    <script>
        ...
        const correctPronunciations = <?php echo json_encode($correctPronunciations); ?>;

        // Display the number of correctly pronounced words in the console
        console.log("Number of correctly pronounced words: " + correctPronunciations);
    </script>
</html>
